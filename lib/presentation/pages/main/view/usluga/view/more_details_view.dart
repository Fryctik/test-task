                              ...
                              widget.typeTariff == TypeTariff.courierExport ||
                                  ...
                                  : Center(
                                      child: Image.asset(Assets.imageCustomBigT,
                                          height: 134.91.h, width: 257.96,gaplessPlayback:true,)),
                              SizedBox(
                                height: 8.h,
                              ),
                              widget.typeTariff == TypeTariff.courierExport ||
                  ...
                  child: CommonWidgetButton(
                    ...
                    openPath: () {
                      ...
                      validateNameFunc();
                          ...
                          if(isError == false && _validateName == true && _validateDes == true){
                            context.pop();
                            setState(() {});
                            showInfoNotification(context, "Благодарим за отправленную заявку. В ближайшее время с вами свяжется менеджер", 80);
