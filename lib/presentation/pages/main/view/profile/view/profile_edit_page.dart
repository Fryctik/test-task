...
class _ProfileEditPageViewState extends State<ProfileEditPageView> {
  ...
  final List<BadgeItem> badges = [
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Зелёный новобранец',
        color: AppColors.accent,
        [AppColors.white, AppColors.black, AppColors.accent]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Гик - собиратель',
        color: Color(0xffDADE2E),
        [AppColors.white, AppColors.black, Color(0xffDADE2E)]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Знаток фракций',
        color: Color(0xffF0BB31),
        [AppColors.white, AppColors.black, Color(0xffF0BB31)]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Мастер сортировки',
        color: Color(0xffF08131),
        [AppColors.white, AppColors.black, Color(0xffF0BB31)]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Эко рейнджер',
        color: Color(0xffF03131),
        [AppColors.white, AppColors.black, Color(0xffF03131)]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Гуру ресурсов',
        color: Color(0xffF234EB),
        [AppColors.white, AppColors.black, Color(0xffF234EB)]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Гигант утилизатор',
        color: Color(0xff8F42E3),
        [AppColors.white, AppColors.black, Color(0xff8F42E3)]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Спаситель природы',
        color: Color(0xff2848ED),
        [AppColors.white, AppColors.black, Color(0xff2848ED)]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Хранитель экосистем',
        color: Color(0xff228EF2),
        [AppColors.white, AppColors.black, Color(0xff228EF2)]),
    BadgeItem(
        img: Assets.iconsStar16x16,
        text: 'Вершитель биосферы',
        color: Color(0xff1CD1EA),
        [AppColors.white, AppColors.black, Color(0xff1CD1EA)], ),
  ];
                                    ...
                                    children: [
                                      Stack(
                                        ...
                                        children: [
                                          ...
                                          bottom: -15,
                                              child: BadgeWidget(badge: badges[9])),
                                          // AnimatedGradientBadge(badge: badges[9]),
                                          // Center(
                                          //   child: Container(
                                          //     width: 200,
                                      ...
                                      return Theme(
                                        ...
                                        child: AlertDialog(
                                          ...
                                          content: Container(
                                            width: 350.w,
                                            child: Text(
                                              'Хотите выйти из профиля?'.toUpperCase(),
                                              textAlign: TextAlign.center,
                                              style: AppTextStyles
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        ...
                                        content: Container(
                                          width: 350.w,
                                          child: Text(
                                            'навсегда удалить ваш профиль?'.toUpperCase(),
                                            textAlign: TextAlign.center,
                                            style:
