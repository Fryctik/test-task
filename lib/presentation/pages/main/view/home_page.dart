...
import 'package:test/presentation/pages/main/view/usluga/components/custom_tariff_view.dart';
                    ...
                    onPageChanged: (index) {
                      setState(() {
                        ...
                        Future.delayed(Duration(milliseconds: 50), () {
                          if (index == 0) {
                            _scrollController.animateTo(scrollOffset, duration: Duration(milliseconds: 300), curve: Curves.linear);
                          }
                        });
                      });
                    },
