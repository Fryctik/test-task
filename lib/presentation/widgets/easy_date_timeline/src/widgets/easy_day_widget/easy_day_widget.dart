...
import 'package:test/presentation/widgets/easy_date_timeline/src/properties/day_style.dart';
import 'package:test/presentation/widgets/easy_date_timeline/src/properties/easy_day_props.dart';
...
class EasyDayWidget extends StatelessWidget {
  ...
  DayInfoText _buildDayNumber(bool isToday) {
    ...
    return DayInfoText(
      ...
      textStyle: dayNumStyle.copyWith(
          color: date.day.isOdd? AppColors.main: null
      ),
    );
  }
  ...
  DayInfoText _buildDayString(bool isToday) {
    ...
    return DayInfoText(
      ...
      textStyle: dayStrStyle.copyWith(
        color: date.day.isOdd? AppColors.black: null
      ),
    );
  }
