    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          widget.typeTariff == TypeTariff.courierExport || widget.typeTariff == TypeTariff.truckExport?  Text(widget.typeTariff == TypeTariff.courierExport?  "от 20 кг" : "от 100 кг",style: AppTextStyles.body16GeologicaLight.copyWith(color: AppColors.shade3),):Text("от 500 кг",style: AppTextStyles.body16GeologicaLight.copyWith(color: AppColors.shade3),),
